...
export default function Chat({ apiUrl, tab }: ChatProps) {
  ...
  const [tableData, setTableData] = useState<TableData[]>([
    ...
    { label: "Type d'acquéreur", value: "", key: "type_acquereur", required: false },
    { label: "Code NAF", value: "", key: "code_naf", required: false },
    { label: "Nombre de collaborateurs", value: "", key: "nb_collaborateurs", required: false },
    { label: "Localisation", value: "", key: "localisation", required: false },
    { label: "Chiffre d'affaires moyen (2 dernières années)", value: "", key: "niveau_ca", required: false },
    { label: "Calendrier", value: "", key: "calendrier", required: false },
    { label: "Fonds disponibles", value: "", key: "fonds_disponibles", required: false },
  ...
  const isFormValid = () => {
    return tableData.every((item) => !item.required || item.value.trim() !== "");
  };
  ...
  return (
    <div className="flex flex-col md:flex-row items-start justify-center min-h-screen bg-white text-gray-900">
      <div className={`flex flex-col py-20 w-full ${tab ? "md:w-2/3" : "max-w-4xl"}`}>
        {/* Chat messages */}
            ...
            return (
              <div key={index} className="mb-4">
                ...
                >
                  ...
                  <div dangerouslySetInnerHTML={{ __html: contentWithoutJSON }} />
                </div>
              </div>
            );
          })}
        ...
        {/* Input form */}
        <div className="fixed bottom-0 left-0 right-0 md:left-auto md:right-auto md:w-2/3 max-w-3xl mb-8 px-4">
          <form
