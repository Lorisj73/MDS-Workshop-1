...
export default function Chat({ apiUrl }: ChatProps) {
  ...
  return (
    <div className="flex items-start justify-center min-h-screen bg-white text-gray-900">
      <div className={`flex flex-col py-20 w-2/3`}>
        ...
        <form
          ...
          className="fixed bottom-0 w-2/3 max-w-3xl p-4 mb-8 bg-[#f4f4f4] dark:bg-token-main-surface-secondary rounded-2xl flex items-center gap-2 border-0"
        >
          <input
